...
<div id ="maindiv">
 ...
 <table id ="tableReg">
 <tr>
     <td colspan="2" style="text-align:center;background-color:#87CEEB;ccf;padding:10px;color:#4B0082;font-size:18px;">Add Threat Location</td>
 </tr>
 <tr>
     <td width="140px;">Threat Location</td>
     <td><input type="text"name="loca"placeholder="enter threat location"id="ID" /><span style="color:#F00">*</span></td>
 </tr>
<tr>
     <td width="140px;">Location Reference</td>
     <td><input type="text"name="ref"placeholder="enter location reference"id="ID" /><span style="color:#F00">*</span></td>
 </tr>
  <tr>
...
{	
	...
	String s="insert into local values('"+loca+"','"+ref+"');";
	st.executeUpdate(s);
        	String t="select * from local where local='"+loca+"';";
        ResultSet rs=st.executeQuery(t);
	if(rs.next())
	{
		%><script src="https://ajax.googleapis.com/ajax/libs/jquery/3.4.0/jquery.min.js"></script>
<script>confirm(v);
         setTimeout(function(){ <%response.sendRedirect("loca_show.jsp"); %> }, 15000);</script><%
	}
