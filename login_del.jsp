...
<div id ="maindiv">
 ...
 <table id ="tableReg">
 <tr>
     <td colspan="2" style="text-align:center;background-color:#87CEEB;ccf;padding:10px;color:#4B0082;font-size:18px;">Delete User Information</td>
 </tr>
 <tr>
...
{	
	...
	Statement st=con.createStatement();
        	String t="delete from login where usern='"+user+"';";
        	st.executeUpdate(t);
        String s="select * from login where arealoc='"+user+"';";
