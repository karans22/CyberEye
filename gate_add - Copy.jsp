...
<div id ="maindiv">
 ...
 <table id ="tableReg">
 <tr>
     <td colspan="2" style="text-align:center;background-color:#87CEEB;ccf;padding:10px;color:#4B0082;font-size:18px;">Add Gate Number</td>
 </tr>
 <tr>
     <td width="140px;">Gate Number</td>
     <td><input type="text"name="gate"placeholder="enter gate number"id="ID" /><span style="color:#F00">*</span></td>
 </tr>
  <tr>
 ...
 <tr>
    ...
    <input type= "submit"style="cursor:pointer" />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type= "reset" value="Reset"  style="cursor:pointer"/>
     ...
     <% String gate=request.getParameter("gate");
        String v="New Threat Type has been added to the list";
        try
{	
	Class.forName("com.mysql.jdbc.Driver");
	Connection con=DriverManager.getConnection("jdbc:mysql://localhost:3306/img","root","Karan@22");
	Statement st=con.createStatement();
	String s="insert into gateno values('"+gate+"');";
	st.executeUpdate(s);
        	String t="select * from gateno where gateno='"+gate+"';";
        ResultSet rs=st.executeQuery(t);
	if(rs.next())
	{
		%><script src="https://ajax.googleapis.com/ajax/libs/jquery/3.4.0/jquery.min.js"></script>
<script>confirm(v);
         setTimeout(function(){ <%response.sendRedirect("gate_show.jsp"); %> }, 15000);</script><%
	}
