...
<div id ="maindiv">
 ...
 <table id ="tableReg">
 <tr>
     <td colspan="2" style="text-align:center;background-color:#87CEEB;ccf;padding:10px;color:#4B0082;font-size:18px;">Add User Information</td>
 </tr>
 <tr>
     <td width="140px;">Username</td>
     <td><input type="text"name="user"placeholder="enter username"id="ID" /><span style="color:#F00">*</span></td>
 </tr>
 <tr>
     <td width="140px;">Password</td>
     <td><input type="text"name="pass"placeholder="enter password"id="ID" /><span style="color:#F00">*</span></td>
 </tr>
  <tr>
     <td width="140px;">Full Name</td>
     <td><input type="text"name="name"placeholder="enter full name"id="ID" /><span style="color:#F00">*</span></td>
 </tr>
  <tr>
     <td width="140px;">Mobile Number</td>
     <td><input type="number"name="mobno"placeholder="enter mobile number"id="ID" /><span style="color:#F00">*</span></td>
 </tr>
 ...
 <tr>
    ...
    <input type= "submit"style="cursor:pointer" />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type= "reset" value="Reset"  style="cursor:pointer"/>
     ...
     <% String user=request.getParameter("user");
        ...
        String v="New User has been added to the list";
        try
{	
	Class.forName("com.mysql.jdbc.Driver");
	Connection con=DriverManager.getConnection("jdbc:mysql://localhost:3306/img","root","Karan@22");
	Statement st=con.createStatement();
	String s="insert into login values('"+user+"','"+pass+"','"+name+"','"+mobno+"');";
	st.executeUpdate(s);
        	String t="select * from login where usern='"+user+"';";
        ResultSet rs=st.executeQuery(t);
	if(rs.next())
	{
		%><script src="https://ajax.googleapis.com/ajax/libs/jquery/3.4.0/jquery.min.js"></script>
<script>confirm(v);
         setTimeout(function(){ <%response.sendRedirect("login_show.jsp"); %> }, 15000);</script><%
	}
