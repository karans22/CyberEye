...
<div id ="maindiv">
 ...
 <div id="formdiv">
 <form method="POST"name= "myform"on onsubmit="return(validate());">

 <table id ="tableReg">
 <tr>
     <td colspan="2" style="text-align:center;background-color:#87CEEB;ccf;padding:10px;color:#4B0082;font-size:18px;">Add Area Location</td>
 </tr>
 <tr>
     <td width="140px;">Area Location</td>
     <td><input type="text"name="area"placeholder="enter area location"id="ID" /><span style="color:#F00">*</span></td>
 </tr>
<tr>
     <td width="140px;">Location Address</td>
     <td><input type="text"name="addr"placeholder="enter area location"id="ID" /><span style="color:#F00">*</span></td>
 </tr>
<tr>
     <td width="140px;">Location Incharge</td>
     <td><input type="text"name="inch"placeholder="enter area location"id="ID" /><span style="color:#F00">*</span></td>
 </tr>
<tr>
     <td width="140px;">Incharge Mobile No.</td>
     <td><input type="text"name="mobin"placeholder="enter area location"id="ID" /><span style="color:#F00">*</span></td>
 </tr>
  <tr>
 ...
 <tr>
    ...
    <input type= "submit"style="cursor:pointer" />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type= "reset" value="Reset"  style="cursor:pointer"/>
     ...
     <% String area=request.getParameter("area");
        ...
        String mobin=request.getParameter("mobin");
        try
{	
	Class.forName("com.mysql.jdbc.Driver");
	Connection con=DriverManager.getConnection("jdbc:mysql://localhost:3306/img","root","Karan@22");
	Statement st=con.createStatement();
	String s="insert into arealoc values('"+area+"','"+addr+"','"+inch+"','"+mobin+"');";
	st.executeUpdate(s);
        	String t="select * from arealoc where arealoc='"+area+"';";
        ResultSet rs=st.executeQuery(t);
	if(rs.next())
	{
		%><script src="https://ajax.googleapis.com/ajax/libs/jquery/3.4.0/jquery.min.js"></script>
<script>confirm(v);
         setTimeout(function(){ <%response.sendRedirect("area_show.jsp"); %> }, 15000);</script><%
	}
