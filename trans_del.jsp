...
<div id ="maindiv">
 ...
 <table id ="tableReg">
 <tr>
     <td colspan="2" style="text-align:center;background-color:#87CEEB;ccf;padding:10px;color:#4B0082;font-size:18px;">Delete Threat Tranaction</td>
 </tr>
 <tr>
     <td width="140px;">Threat Transaction Id</td>
     <td><input type="text"name="transid"placeholder="enter threat trans id"id="ID" /><span style="color:#F00">*</span></td>
 </tr>
  <tr>
...
{	
	...
	Statement st=con.createStatement();
        	String t="delete from threattrans where trans_id='"+transid+"';";
        	st.executeUpdate(t);
         String s="select * from threattrans where trans_id='"+transid+"';";
...
<script>confirm(v);
         setTimeout(function(){ <%response.sendRedirect("trans_show.jsp"); %> }, 5000);</script><%
}
}
catch(Exception e){
    e.printStackTrace();
