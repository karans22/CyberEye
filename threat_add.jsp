...
<div id ="maindiv">
 ...
 <table id ="tableReg">
 <tr>
     <td colspan="2" style="text-align:center;background-color:#87CEEB;ccf;padding:10px;color:#4B0082;font-size:18px;">Add Threat</td>
 </tr>
 <tr>
     <td width="140px;">Threat Type</td>
     <td><input type="text"name="threat"placeholder="enter threat type"id="ID" /><span style="color:#F00">*</span></td>
 </tr>
<tr>
     <td width="140px;">Threat Details</td>
     <td><input type="text"name="detail"placeholder="enter threat detail"id="ID" /><span style="color:#F00">*</span></td>
 </tr>
  <tr>
...
{	
	...
	String s="insert into threat values('"+threat+"','"+detail+"');";
	st.executeUpdate(s);
        	String t="select * from threat where threat='"+threat+"';";
        ResultSet rs=st.executeQuery(t);
	if(rs.next())
	{
		%><script src="https://ajax.googleapis.com/ajax/libs/jquery/3.4.0/jquery.min.js"></script>
<script>confirm(v);
         setTimeout(function(){ <%response.sendRedirect("threat_show.jsp"); %> }, 5000);</script><%
	}
