...
{	
	...
	String s="select Trans_id,arealoc,gateno,local,threat,date from threattrans order by trans_id;";
...
%>
 ...
 <form action="trans_check.jsp" method="POST"name= "myform"on onsubmit="return(validate());">

 <table id ="tableReg">
      </br>
 <tr>
     <td colspan="2" style="text-align:center;background-color:#87CEEB;ccf;padding:10px;color:#4B0082;font-size:18px;">Location Search</td>
 </tr>
 <tr>
     <td width="140px;">Transaction Id</td>
     <td><input type="text"name="transid"placeholder="enter transaction id"id="ID" /><span style="color:#F00">*</span></td>
 </tr>
  <tr>
