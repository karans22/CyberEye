...
<div id ="maindiv">
 ...
 <table id ="tableReg">
 <tr>
     <td colspan="2" style="text-align:center;background-color:#87CEEB;ccf;padding:10px;color:#4B0082;font-size:18px;">Add Tablet Information</td>
 </tr>
 <tr>
     <td width="140px;">Tablet</td>
     <td><input type="text"name="tab"placeholder="enter threat type"id="ID" /><span style="color:#F00">*</span></td>
 </tr>
<tr>
     <td width="140px;">Condition</td>
     <td><input type="text"name="cond"placeholder="enter threat detail"id="ID" /><span style="color:#F00">*</span></td>
 </tr>
  <tr>
...
{	
	...
	String s="insert into tablet values('"+tab+"','"+cond+"');";
	st.executeUpdate(s);
        	String t="select * from tablet where tablet='"+tab+"';";
        ResultSet rs=st.executeQuery(t);
	if(rs.next())
	{
		%><script src="https://ajax.googleapis.com/ajax/libs/jquery/3.4.0/jquery.min.js"></script>
<script>confirm(v);
         setTimeout(function(){ <%response.sendRedirect("tab_show.jsp"); %> }, 5000);</script><%
	}
